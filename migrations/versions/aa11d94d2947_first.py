...
Revision ID: aa11d94d2947
Revises: 
Create Date: 2025-09-10 11:07:18.920735
...
def upgrade():
    ...
    op.create_table('homepage_video',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(length=200), nullable=False),
    ...
    sa.Column('image_url', sa.String(length=200), nullable=False),
    sa.Column('audio_url', sa.String(length=200), nullable=False),
    sa.Column('publish_date', sa.DateTime(), nullable=False),
    sa.Column('is_published', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('upcoming_episode',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(length=200), nullable=False),
    sa.Column('description', sa.Text(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('user')
    op.drop_table('upcoming_episode')
    op.drop_table('podcast_episode')
    op.drop_table('homepage_video')
    op.drop_table('event')
